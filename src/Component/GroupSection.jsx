                    ...
                    <div className={Styles.sectionone}>
                        ...
                        <div className={Styles.contenar}>
                            <div>
                                <div className={Styles.groupbody}>
                                    {useSection.map((group) => (
                                        <div key={group.name} onClick={() => handleGroupClick(group.name)} className={Styles.section}>
                        ...
                        {isInputBoxVisible ? (
                            <>
                                <h2 className={Styles.header}>
                                    ...
                                    <span className={Styles.colorboxtwo} style={{ backgroundColor: selectedGroup.Color }} >
                                        {selectedGroup.charAt(0).toUpperCase()}
                                        {selectedGroup.charAt(1).toUpperCase()}
                                    </span>
                                    {selectedGroup}
                            ...
                            <div className={Styles.emptypage}>
                                <img className={Styles.imagetab} />

                                <h1 className='emptypage'>Pocket Notes</h1>
